...
SECRET_KEY = 'django-insecure-pvv23@5#^ir=!(n1x#0mn&tbkdk50^d4sn*-yd&c24n^n!=bz3'
...
# STATIC_URL = '/static/'
# STATIC_ROOT = os.path.join(BASE_DIR, 'EBazaar')
# STATICFILES_DIRS = [
#     # Add the path to your static files directory
#     '/Users/razza/OneDrive/Desktop/ECommerce/EBazaar/static/EBazaar',
